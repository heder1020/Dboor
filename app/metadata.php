...
$GameMetadata  = array(
    ...
    'player_protection_period' => 86400,
    'session_timeout' => 5,
    'tribes' => array(
         '1' => array(
             'dual_build' => TRUE,
            'merchants_capacity' => ( $Market * 500 ) / $speed,
            'merchants_velocity' => $attack * 16,
            'crannyFactor' => 1,
            'wall_css' => 'd2_11' 
        ),
        '2' => array(
             'dual_build' => FALSE,
            'merchants_capacity' => ( $Market * 1000 ) / $speed,
            'merchants_velocity' => $attack * 12,
            'crannyFactor' => 2 / 3,
            'wall_css' => 'd2_12' 
        ),
        '3' => array(
             'dual_build' => FALSE,
            'merchants_capacity' => ( $Market * 750 ) / $speed,
            'merchants_velocity' => $attack * 24,
            'crannyFactor' => 1,
            'wall_css' => 'd2_1' 
        ),
        '4' => array(
             'dual_build' => FALSE,
            'merchants_capacity' => 0,
            'merchants_velocity' => 0,
            'crannyFactor' => 1,
            'wall_css' => '' 
        ),
        '5' => array(
        ...
        '6' => array(
             'dual_build' => TRUE,
            'merchants_capacity' => ( $Market * 1500 ) / $speed,
            'merchants_velocity' => $attack * 22,
            'crannyFactor' => 2 / 3,
            'wall_css' => 'd2_11' 
        ),
        '7' => array(
             'dual_build' => TRUE,
            'merchants_capacity' => ( $Market * 1200 ) / $speed,
            'merchants_velocity' => $attack * 20,
            'crannyFactor' => 1,
            'wall_css' => 'd2_11' 
        ) 
    ),
    ...
    'troops' => array(
        ...
        '5' => array(
             'for_tribe_id' => 1,
            'velocity' => ( $attack * 14 ) / $speed,
            'carry_load' => $carry * 100,
            'crop_consumption' => 3,
            'attack_value' => 120,
            'defense_infantry' => 65,
            'defense_cavalry' => 50,
        ...
        '42' => array(
             'for_tribe_id' => 5,
            'velocity' => ( $attack * 40 ) / $speed,
            'carry_load' => $carry * 0,
            'crop_consumption' => 0,
            'attack_value' => 120,
            'defense_infantry' => 220,
            'defense_cavalry' => 330,
            'is_cavalry' => FALSE,
            'gold_needed' => 0,
            'research_time_consume' => 0,
        ...
        '43' => array(
             'for_tribe_id' => 5,
            'velocity' => ( $attack * 50 ) / $speed,
            'carry_load' => $carry * 0,
            'crop_consumption' => 0,
            'attack_value' => 100,
            'defense_infantry' => 310,
            'defense_cavalry' => 170,
            'is_cavalry' => FALSE,
            'gold_needed' => 0,
            'research_time_consume' => 0,
        ...
        '44' => array(
             'for_tribe_id' => 5,
            'velocity' => ( $attack * 60 ) / $speed,
            'carry_load' => $carry * 0,
            'crop_consumption' => 0,
            'attack_value' => 200,
            'defense_infantry' => 200,
            'defense_cavalry' => 200,
            'is_cavalry' => TRUE,
            'gold_needed' => 0,
            'research_time_consume' => 0,
        ...
        '45' => array(
             'for_tribe_id' => 5,
            'velocity' => ( $attack * 70 ) / $speed,
            'carry_load' => $carry * 0,
            'crop_consumption' => 0,
            'attack_value' => 300,
            'defense_infantry' => 430,
            'defense_cavalry' => 210,
            'is_cavalry' => TRUE,
            'gold_needed' => 0,
            'research_time_consume' => 0,
    ...
    'items' => array(
         '1' => array(
            ...
            'built_in_capital' => TRUE,
            'built_in_non_capital' => TRUE,
            'built_in_special_only' => FALSE,
            'max_lvl_in_non_capital' => 10,
            'for_tribe_id' => array(
                 '1' => 1,
                '2' => 1,
                '3' => 1,
