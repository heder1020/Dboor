...
class GuideModel extends ModelBase {
	...
	function increaseGoldNumber($playerId, $golds) {
	...
	function isOpenedMessage($messageId) {
	...
	function addResourcesTo($villageId, $resourcesArray) {
		...
		foreach ($r_arr as $r_str) {
			$r2 = explode( ' ', $r_str );
			$resources[$r2[0]] = array( 'current_value' => $r2[1] + $resourcesArray[$i++], 'store_max_limit' => $r2[2], 'store_init_limit' => $r2[3], 'prod_rate' => $r2[4], 'prod_rate_percentage' => $r2[5] );
