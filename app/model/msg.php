...
class MessageModel extends ModelBase {
	...
	function getMessageListCount($playerId, $inbox) {
	...
	function getMessageList($playerId, $inbox, $pageIndex, $pageSize) {
	...
	function getMessage($playerId, $messageId) {
	...
	function _getSafeMessage($playerId, $messageId) {
		return $this->provider->fetchResultSet( 'SELECT
				m.to_player_id,
				m.is_readed,
				m.delete_status
	...
	function deleteMessage($playerId, $messageId) {
	...
	function changeUnReadedMessages($playerId, $offset) {
