...
class GPage extends SecureGamePage
{
    var $x = null;
    var $y = null;
    var $directionsMatrix = null;
    var $stepDirectionsMatrix = null;
    var $rad = null;
    var $matrixSet = array( );
    var $contractsAllianceId = array( );
    var $json = null;
    var $largeMap = FALSE;
    function GPage( )
    {
    ...
    function isContractWith( $allianceId )
    {
    ...
    function getCssClassNameByItem( $mapItem )
    {
        if ( $mapItem['is_oasis'] ) {
        ...
        if ( $mapItem['player_id'] != '' ) {
            ...
            if ( $mapItem['people_count'] < 100 ) {
                ...
                if ( $mapItem['people_count'] < 250 ) {
                    $c1 = 1;
                } else {
                    if ( $mapItem['people_count'] < 500 ) {
                        $c1 = 2;
                    } else {
                        $c1 = 3;
                    }
            ...
            if ( $this->player->playerId == $mapItem['player_id'] ) {
                ...
                if ( $mapItem['alliance_id'] != '' ) {
                    if ( $this->data['alliance_id'] == $mapItem['alliance_id'] ) {
                        ...
                        if ( $this->isContractWith( $mapItem['alliance_id'] ) ) {
                            $c2 = 3;
                        }
                    }
                }
    ...
    function getMapAreaTitle( $mapItem )
    {
        $title = '';
        if ( $mapItem['is_oasis'] ) {
