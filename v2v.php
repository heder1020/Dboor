...
class GPage extends VillagePage
{
    ...
    var $catapultCanAttack = array( 0 => 0, 1 => 10, 2 => 11, 3 => 9, 4 => 6, 5 => 2, 6 => 4, 7 => 8, 8 => 7, 9 => 3, 10 => 5, 11 => 1, 12 => 22, 13 => 13, 14 => 19, 15 => 12, 16 => 35, 17 => 18, 18 => 29, 19 => 30, 20 => 37, 21 => 41, 22 => 15, 23 => 17, 24 => 26, 25 => 16, 26 => 25, 27 => 20, 28 => 14, 29 => 24, 30 => 28, 31 => 40, 32 => 21, 33 => 27 );
    ...
    function load( )
    {
        ...
        if ( ( !$villageRow['is_oasis'] AND intval( $villageRow['player_id'] ) == 0 ) ) {
            ...
            if ( $this->isPost() ) {
                ...
                if ( $this->attackWithCatapult ) {
                    ...
                    $i                        = 10;
                    while ( $i <= 28 ) {
                        if ( ( ( ( ( ( ( ( ( ( ( ( $i == 10 OR $i == 11 ) OR $i == 15 ) OR $i == 17 ) OR $i == 18 ) OR $i == 24 ) OR $i == 25 ) OR $i == 26 ) OR $i == 27 ) OR $i == 28 ) OR $i == 38 ) OR $i == 39 ) ) {
                            if ( $this->_containBuildingTarget( $i ) ) {
                                $selectComboTargetOptions .= sprintf( '<option value="%s">%s</option>', $i, constant( 'item_' . $i ) );
                            }
                        }
        ...
        if ( $this->pageState == 2 ) {
            ...
            $this->targetVillage['needed_time'] = intval( $distance / $this->_getTheSlowestTroopSpeed( $renderTroops, $this->data ) * 3600 );
        ...
        if ( $this->isPost() ) {
            ...
            if ( ( !$this->isGameTransientStopped() AND !$this->isGameOver() ) ) {
                ...
                $newTask->tag         = array(
                    ...
                    'hasHero' => FALSE,
                    'resources' => NULL,
                    'troopsCropConsume' => $this->_getTroopCropConsumption( $sendTroopsArray ) 
                );
                $this->queueModel->addTask( $newTask );
                $m->dispose();
                $this->redirect( 'build.php?id=39' );
    ...
    function _getTheSlowestTroopSpeed( $troopsArray, $targetvillageinfo = false )
    {
        $minSpeed = 0 - 1;
